...
class M2mClient(object):
    ...
    def __init__(self, base_url=None, timeout=120, logger=None, user=None, token=None, toc=None):
    ...
    def search_subsites(self, target_subsite):
        ...
        Parameters:
            target_subsite: partial or full subsite name'''
